...
module.exports = {
    ...
    handler: async(args) => {
        ...
        try {
            ...
            if (fs.existsSync(path.resolve('./zeus-cmd/dist/mapping.js')))
                fs.writeFileSync(path.resolve('./zeus-cmd/dist/mapping.js'), `module.exports = ${JSON.stringify(boxes, null, 2)};`);
