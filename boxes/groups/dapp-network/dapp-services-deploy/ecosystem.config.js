...
const EVM_ROPSTEN_MAX_PRIORITY_FEE_PER_GAS = globalEnv.EVM_ROPSTEN_MAX_PRIORITY_FEE_PER_GAS || '500000';
const EVM_ROPSTEN_MAX_FEE_PER_GAS = globalEnv.EVM_ROPSTEN_MAX_FEE_PER_GAS || '500000';
const EVM_ROPSTEN_KEYS_PER_CONSUMER = globalEnv.EVM_ROPSTEN_KEYS_PER_CONSUMER || '';
const EVM_ROPSTEN_GAS_PRICE_MULT = Number(globalEnv.EVM_ROPSTEN_KEYS_PER_CONSUMER) || 1.2;
...
const EVM_RINKEBY_MAX_PRIORITY_FEE_PER_GAS = globalEnv.EVM_RINKEBY_MAX_PRIORITY_FEE_PER_GAS || '500000';
const EVM_RINKEBY_MAX_FEE_PER_GAS = globalEnv.EVM_RINKEBY_MAX_FEE_PER_GAS || '500000';
const EVM_RINKEBY_KEYS_PER_CONSUMER = globalEnv.EVM_RINKEBY_KEYS_PER_CONSUMER || '';
const EVM_RINKEBY_GAS_PRICE_MULT = Number(globalEnv.EVM_RINKEBY_KEYS_PER_CONSUMER) || 1.2;
...
const EVM_MATIC_MAX_PRIORITY_FEE_PER_GAS = globalEnv.EVM_MATIC_MAX_PRIORITY_FEE_PER_GAS || '500000';
const EVM_MATIC_MAX_FEE_PER_GAS = globalEnv.EVM_MATIC_MAX_FEE_PER_GAS || '500000';
const EVM_MATIC_KEYS_PER_CONSUMER = globalEnv.EVM_MATIC_KEYS_PER_CONSUMER || '';
const EVM_MATIC_GAS_PRICE_MULT = Number(globalEnv.EVM_MATIC_KEYS_PER_CONSUMER) || 1.2;
...
const EVM_MUMBAI_MAX_PRIORITY_FEE_PER_GAS = globalEnv.EVM_MUMBAI_MAX_PRIORITY_FEE_PER_GAS || '500000';
const EVM_MUMBAI_MAX_FEE_PER_GAS = globalEnv.EVM_MUMBAI_MAX_FEE_PER_GAS || '500000';
const EVM_MUMBAI_KEYS_PER_CONSUMER = globalEnv.EVM_MUMBAI_KEYS_PER_CONSUMER || '';
const EVM_MUMBAI_GAS_PRICE_MULT = Number(globalEnv.EVM_MUMBAI_KEYS_PER_CONSUMER) || 1.2;
...
const EVM_BINANCE_MAX_PRIORITY_FEE_PER_GAS = globalEnv.EVM_BINANCE_MAX_PRIORITY_FEE_PER_GAS || '500000';
const EVM_BINANCE_MAX_FEE_PER_GAS = globalEnv.EVM_BINANCE_MAX_FEE_PER_GAS || '500000';
...
const EVM_BSCTEST_MAX_PRIORITY_FEE_PER_GAS = globalEnv.EVM_BSCTEST_MAX_PRIORITY_FEE_PER_GAS || '500000';
const EVM_BSCTEST_MAX_FEE_PER_GAS = globalEnv.EVM_BSCTEST_MAX_FEE_PER_GAS || '500000';
