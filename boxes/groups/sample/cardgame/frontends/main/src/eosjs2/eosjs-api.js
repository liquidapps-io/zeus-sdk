 ...
 var abiAbi = require('./abi.abi.json');
 // tslint:disable-next-line
 var transactionAbi = require('./transaction.abi.json');
 var Api = /** @class */ (function() {
           ...
           return __awaiter(_this, void 0, void 0, function() {
             ...
             return __generator(this, function(_b) {
               switch (_b.label) {
                 ...
                 case 1:
                   return [2 /* return */ , (_a.abi = (_b.sent()).rawAbi,
                     _a)];
               }
             });
           });
   ...
   Api.prototype.transact = function(transaction, _a) {
     var _b = _a === void 0 ? {} : _a;
     var _c = _b.broadcast;
     var broadcast = _c === void 0 ? true : _c;
     var blocksBehind = _b.blocksBehind;
     var expireSeconds = _b.expireSeconds;
     return __awaiter(this, void 0, void 0, function() {
       ...
       return __generator(this, function(_f) {
         switch (_f.label) {
           ...
           case 3:
             ...
             _f.label = 4;
           case 4:
             return [4 /* yield */ , this.rpc.get_block(info.head_block_num - blocksBehind)];
           case 5:
             refBlock = _f.sent();
   ...
   Api.prototype.hasRequiredTaposFields = function(_a) {
     ...
     var ref_block_num = _a.ref_block_num;
     var ref_block_prefix = _a.ref_block_prefix;
     var transaction = __rest(_a, ['expiration', 'ref_block_num', 'ref_block_prefix']);
