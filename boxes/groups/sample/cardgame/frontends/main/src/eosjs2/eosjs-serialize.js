...
var SerialBuffer = /** @class */ (function () {
  ...
  function SerialBuffer (_a) {
    var _b = _a === void 0 ? {} : _a; var textEncoder = _b.textEncoder; var textDecoder = _b.textDecoder; var array = _b.array;
  ...
  SerialBuffer.prototype.getSymbolCode = function () {
    ...
    return this.textDecoder.decode(new Uint8Array(a.buffer, a.byteOffset, len));
  };
  /** Append a `symbol` */
  SerialBuffer.prototype.pushSymbol = function (_a) {
    var name = _a.name; var precision = _a.precision;
  ...
  SerialBuffer.prototype.getAsset = function () {
    ...
    var _a = this.getSymbol(); var name = _a.name; var precision = _a.precision;
...
function getTypesFromAbi (initialTypes, abi) {
  ...
  if (abi.types) {
    try {
      for (var _f = __values(abi.types), _g = _f.next(); !_g.done; _g = _f.next()) {
        var _h = _g.value; var new_type_name = _h.new_type_name; var type = _h.type;
  ...
  if (abi.structs) {
    try {
      for (var _j = __values(abi.structs), _k = _j.next(); !_k.done; _k = _j.next()) {
        var _l = _k.value; var name_1 = _l.name; var base = _l.base; var fields = _l.fields;
        types.set(name_1, createType({
          name: name_1,
          baseName: base,
          fields: fields.map(function (_a) {
            var n = _a.name; var type = _a.type;
  ...
  if (abi.variants) {
    try {
      for (var _m = __values(abi.variants), _o = _m.next(); !_o.done; _o = _m.next()) {
        var _p = _o.value; var name_2 = _p.name; var t = _p.types;
  ...
  try {
    for (var types_1 = __values(types), types_1_1 = types_1.next(); !types_1_1.done; types_1_1 = types_1.next()) {
      var _q = __read(types_1_1.value, 2); var name_3 = _q[0]; var type = _q[1];
      if (type.baseName) {
  ...
  } catch (e_8_1) { e_8 = { error: e_8_1 }; } finally {
    try {
