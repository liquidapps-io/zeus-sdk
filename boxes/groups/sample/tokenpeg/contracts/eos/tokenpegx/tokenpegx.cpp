...
void tokenpegx::enable(bool processing_enabled, bool transfers_enabled)
 {
  require_auth(_self);
  settings_table settings_singleton(_self, _self.value);
...
void tokenpegx::transfer(name from, name to, asset quantity, string memo) {
