...
CONTRACT dgoods: public contract {
    public:
        ...
        TABLE tokenconfigs {
            ...
            symbol_code symbol;
            uint64_t category_name_id;
            uint64_t dgood_available_primary_key;
        };
        ...
        using dgood_index = dapp::multi_index< "dgood"_n, dgood >;

        typedef eosio::multi_index<".dgood"_n, account> dgood_t_v_abi;
        TABLE shardbucket {
            std::vector<char> shard_uri;
            uint64_t shard;
            uint64_t primary_key() const { return shard; }
        };
        typedef eosio::multi_index<"dgood"_n, shardbucket> dgood_t_abi;
