...
var Api = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0: return [4 /* yield */, Promise.all(actions.map(function (_a) {
            var account = _a.account; var name = _a.name; var authorization = _a.authorization; var data = _a.data;
            return __awaiter(_this, void 0, void 0, function () {
              var contract;
              return __generator(this, function (_b) {
                switch (_b.label) {
  ...
  Api.prototype.transact = function (transaction, _a) {
    var _b = _a === void 0 ? {} : _a; var _c = _b.broadcast; var broadcast = _c === void 0 ? true : _c; var blocksBehind = _b.blocksBehind; var expireSeconds = _b.expireSeconds;
    return __awaiter(this, void 0, void 0, function () {
  ...
  Api.prototype.pushSignedTransaction = function (_a) {
    var signatures = _a.signatures; var serializedTransaction = _a.serializedTransaction;
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_b) {
  ...
  Api.prototype.hasRequiredTaposFields = function (_a) {
    var expiration = _a.expiration; var ref_block_num = _a.ref_block_num; var ref_block_prefix = _a.ref_block_prefix; var transaction = __rest(_a, ['expiration', 'ref_block_num', 'ref_block_prefix']);
